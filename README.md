...
2. Система безопасно читает семь канонических листов и нормализует стабильные коды.
...
- [ ] Технический Windows alpha EXE: launcher и внутренний installer без решателя — следующий срез.
...
Проект находится на стадии `0.2 alpha`: справочники учебных планов, студентов и помещений готовы, расчёт расписания ещё не реализован. Следующий срез — технический Windows alpha EXE; функциональный появится после календаря и первого решателя. Решение по поставке описано в [ADR-001](docs/decisions/001-windows-distribution.md).
