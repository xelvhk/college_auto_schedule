...
Связанные справочники добавляются только полными наборами. Для совместимости поддерживаются прежние форматы; канонический 11-листовый формат дополнительно включает:
