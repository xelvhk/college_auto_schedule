...
2. Система безопасно читает одиннадцать канонических листов и нормализует стабильные коды.
...
- канонический 11-листовый файл: преподаватели, группы, студенты, нагрузка, учебные планы, корпуса, аудитории, типы помещений и оборудование;
...
Названия столбцов канонического шаблона — русские. Английские технические заголовки из предыдущих версий продолжают приниматься для обратной совместимости. Связанные справочники добавляются только полными наборами; канонический 11-листовый формат включает:
...
- [x] Предпросмотр, сверка часов, дефициты аудиторий и атомарная активация 11 разделов.
...
Проект находится на стадии `0.2.1 alpha`: импорт справочников и технический Windows installer готовы, расчёт расписания ещё не реализован. Следующий срез — календарь и настраиваемые ограничения колледжа; функциональный EXE появится после первого решателя. Решение по поставке описано в [ADR-001](docs/decisions/001-windows-distribution.md).
