...
- [ ] Произвольные учебные циклы и единый отчёт готовности к расчёту.
...
Проект находится на стадии `0.3 alpha`: импорт справочников и календарных ограничений, а также технический Windows installer готовы; расчёт расписания ещё не реализован. Следующий срез — отчёт готовности к расчёту и модель учебных циклов; функциональный EXE появится после первого решателя. Решение по поставке описано в [ADR-001](docs/decisions/001-windows-distribution.md).
