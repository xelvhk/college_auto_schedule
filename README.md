...
2. Система безопасно читает шестнадцать канонических листов и нормализует стабильные коды.
...
- канонический 16-листовый файл: преподаватели, группы, студенты, нагрузка, учебные планы, помещения, календарь, исключения и недоступность ресурсов;
...
Названия столбцов канонического шаблона — русские. Английские технические заголовки из предыдущих версий продолжают приниматься для обратной совместимости. Связанные справочники добавляются только полными наборами; канонический 16-листовый формат включает:
...
- [x] Предпросмотр, сверка часов, дефициты аудиторий и атомарная активация 16 разделов.
...
Проект находится на стадии `0.3 alpha`: импорт справочников и календарных ограничений, отчёт готовности и технический Windows installer готовы; расчёт расписания ещё не реализован. Следующий срез — модель учебных циклов; функциональный EXE появится после первого решателя. Решение по поставке описано в [ADR-001](docs/decisions/001-windows-distribution.md).
